...
import type { Alumni, CollegeInfo } from "@/types";
				...
				<div className="container mx-auto px-4">
					<div className="flex flex-col items-center text-center">
						...
						<p className="text-xl text-gray-600 max-w-2xl mb-8">
							Reconnect with your classmates, stay updated with college events,
				...
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-gray-600 mb-6">
							Our alumni network connects graduates from{" "}
							{collegeInfo?.name || "our institution"} around the world. This
							platform helps alumni stay connected with each other and their
							alma mater, share their experiences, and contribute to the growth
							of current students.
						</p>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
							<div>
								...
								<p className="text-sm text-gray-600">
									Find and reconnect with your classmates and build your
							...
							<div>
								...
								<p className="text-sm text-gray-600">
									Share your experiences and insights with the college
									community.
								</p>
							</div>
							<div>
								...
								<p className="text-sm text-gray-600">
									Support the next generation through donations, mentorship, and
									more.
								</p>
							</div>
						</div>
			...
			<section className="py-16 bg-blue-50">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-gray-600 mb-8 max-w-2xl mx-auto">
						Are you an alumnus? Join our growing network to reconnect with
						classmates, receive updates, and participate in exclusive alumni
						events.
					</p>
					<Link to="/alumni/add">
						<Button className="px-8">Add Your Profile</Button>
					</Link>
				</div>
			</section>
		</div>
