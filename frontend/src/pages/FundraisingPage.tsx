				...
				<div className="container mx-auto px-4">
					<div className="max-w-3xl mx-auto text-center">
						...
						<p className="text-xl text-gray-600 mb-8">
							Your contribution makes a significant impact on our institution
					...
					{loading ? (
						...
						<div className="text-center py-12 bg-white rounded-lg shadow-sm">
							...
							<p className="text-gray-500">
								There are currently no active fundraising campaigns. Please
								check back later.
							</p>
						</div>
					) : (
												...
												<div className="mb-4">
													...
													<div className="w-full bg-gray-200 rounded-full h-2.5">
														<div
															...
															style={{
																width: `${Math.min(Math.round((featuredCampaign.raised / featuredCampaign.goal) * 100), 100)}%`,
															}}
														></div>
													</div>
												</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
							<div>
								...
								<p className="text-gray-600">
									Browse through our active fundraising campaigns and select one
							...
							<div>
								...
								<p className="text-gray-600">
									Choose how much you'd like to contribute. Every donation, no
							...
							<div>
								...
								<p className="text-gray-600">
									Fill in your details and complete the secure donation process.
			...
			<section className="py-16 bg-blue-50">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
						Your support helps us create better opportunities for current and
						future students. Together, we can build a stronger educational
						foundation.
					</p>
