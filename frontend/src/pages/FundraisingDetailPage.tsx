...
import type { FundraisingCampaign, Donation } from "@/types";
					...
					<Card className="bg-blue-50 border-blue-100">
						<CardContent className="pt-6">
							...
							<p className="text-gray-600 mb-4">
								Your contribution will help us reach our goal of $
								{campaign.goal.toLocaleString()}. Every donation counts, no
								matter how small.
							</p>
							<Link to={`/fundraising/${campaign.id}/donate`}>
