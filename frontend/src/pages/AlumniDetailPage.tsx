		...
		return (
			<div className="container mx-auto px-4 py-8 text-center">
				...
				<p className="text-gray-600 mb-6">
					The alumni you are looking for doesn't exist or has been removed.
				</p>
				<Link to="/alumni">
				...
				<div className="flex flex-col md:flex-row justify-between md:items-center">
					...
					<div className="flex space-x-2 mt-4 md:mt-0">
						{isAdmin && (
							<Button
								variant="outline"
								onClick={() => navigate(`/admin/alumni/edit/${alumni.id}`)}
							>
							...
							<div className="flex flex-col items-center text-center">
								<div className="h-32 w-32 rounded-full overflow-hidden mb-4">
									<img
										src={
											alumni.image ||
											`https://ui-avatars.com/api/?name=${alumni.name}&size=128`
										}
										alt={alumni.name}
								...
								<div className="w-full">
									...
									<div className="space-y-2">
										...
										{alumni.otherProfiles &&
											Object.entries(alumni.otherProfiles).map(
												([key, value]) => (
													<a
														key={key}
														href={value}
