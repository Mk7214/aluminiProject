...
export default function FeedbackPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			toast.success(
				"Thank you for your feedback! It will be reviewed by an administrator.",
			);
					...
					>
						...
						<DialogContent className="sm:max-w-[500px]">
							<DialogHeader>
								...
								<DialogDescription>
									Share your thoughts, experiences, and memories about your time
									at the college. Your feedback will be reviewed before being
									published.
								</DialogDescription>
							</DialogHeader>
							<form onSubmit={handleSubmit} className="space-y-4">
								...
								<div className="space-y-2">
									...
									<p className="text-xs text-gray-500">
										You can share a link to a video hosted on YouTube, Vimeo,
										etc.
									</p>
								</div>
								<div className="space-y-2">
