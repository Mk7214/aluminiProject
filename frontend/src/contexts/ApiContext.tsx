...
interface ApiContextType {
	...
	addAlumni: (
		alumni: Omit<Alumni, "id" | "createdAt" | "updatedAt" | "isVerified">,
	) => Promise<Alumni>;
	updateAlumni: (
		id: string,
	...
	addFeedback: (
		feedback: Omit<Feedback, "id" | "createdAt" | "isApproved">,
	) => Promise<Feedback>;
	...
	addCampaign: (
		campaign: Omit<FundraisingCampaign, "id">,
	) => Promise<FundraisingCampaign>;
	updateCampaign: (
		id: string,
		campaignData: Partial<FundraisingCampaign>,
...
export const ApiProvider: React.FC<{ children: ReactNode }> = ({
	...
	const addAlumni = async (
		newAlumni: Omit<Alumni, "id" | "createdAt" | "updatedAt" | "isVerified">,
	): Promise<Alumni> => {
		try {
	...
	const addFeedback = async (
		newFeedback: Omit<Feedback, "id" | "createdAt" | "isApproved">,
	): Promise<Feedback> => {
		try {
	...
	const getDonationsByCampaign = async (
		...
		try {
			...
			console.error(
				`Error fetching donations for campaign ${campaignId}:`,
				error,
			);
